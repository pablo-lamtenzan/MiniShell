...
TEST_SIMPLE_CMD_OUT2="ls > test_simple_cmd_out2"
TEST_SIMPLE_CMD_OUT_v2_1="env > test_simple_cmd_out_v2_empty1 > test_simple_cmd_out_v2_1"
TEST_SIMPLE_CMD_OUT_v2_2="ls > test_simple_cmd_out_v2_empty2 > test_simple_cmd_out_v2_2"
TEST_SIMPLE_CMD_OUT_v3_1="env > test_simple_cmd_out_v3_empty1_1 > test_simple_cmd_out_v3_empty2_1 >test_simple_cmd_out_v3_1"
TEST_SIMPLE_CMD_OUT_v3_2="ls > test_simple_cmd_out_v3_empty1_2 > test_simple_cmd_out_v3_empty2_2 >test_simple_cmd_out_v3_2"
# Semicolons
